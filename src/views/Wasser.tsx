...
import { wasserConfig } from '../config/pages.config';
...
export const Wasser = () => {
  ...
  if (viewMode === 'change') {
    const mergedPanels = mergeControlPanels(wasserConfig.controlPanels, userControlPanels);
    const panelOrder = getEffectivePanelOrder('wasser', userPanelOrder).panelIdOrder;
  ...
  const dashboard = getGrafanaByUid(wasserConfig.grafanaKey || '');
